...
class SetDifferenceIntroduction(Scene):
    def construct(self):
        # Same background color as previous scenes
        self.camera.background_color = "#F0F0F0"
...
class SetDifferenceExamples(Scene):
    def construct(self):
        # Same background color as previous scenes
        self.camera.background_color = "#F0F0F0"
...
class ComplementDefinition(Scene):
    def construct(self):
        # Same background color as previous scenes
        self.camera.background_color = "#F0F0F0"
...
class UniversalSetComplement(Scene):
    def construct(self):
        # Same background color as previous scenes
        self.camera.background_color = "#F0F0F0"
...
class DiceComplementExample(Scene):
    def construct(self):
        # Same background color as previous scenes
        self.camera.background_color = "#F0F0F0"
        ...
        # === STEP 2: CREATE DICE PAIRS FUNCTIONS ===
        
        def create_die_face(number, size=0.25):
        ...
        def create_dice_pair(num1, num2):
            """Create a pair of dice"""
            die1 = create_die_face(num1)
            die2 = create_die_face(num2)
            die2.next_to(die1, RIGHT, buff=0.03)
            return VGroup(die1, die2)
        
        # === STEP 3: ADD DICE PAIRS POSITIONED RELATIVE TO RECTANGLE ===
        ...
        for i, (num1, num2) in enumerate(same_numbers):
            pair = create_dice_pair(num1, num2)
    ...
    # === STEP 4: MOVE SET A TO RIGHT CENTER FIRST ===
        ...
        # === STEP 5: ADD UNIVERSAL SET U AROUND SET A ===
        ...
        # === STEP 6: ADD LABEL U AND CREATE VGROUP ===
    ...
    # === STEP 7: ADD COMPLEMENT DICE PAIRS (A^c) WITH DECREASING COLUMNS ===
...
class ComplementExamples(Scene):
    def construct(self):
        # Same background color as previous scenes
        self.camera.background_color = "#F0F0F0"
...
class ComplementPredicateNegation(Scene):
    def construct(self):
        # Same background color as previous scenes
        self.camera.background_color = "#F0F0F0"
...
class PropertiesOfComplements(Scene):
    def construct(self):
        # Same background color as previous scenes
        self.camera.background_color = "#F0F0F0"
...
class ComplementPropertiesList(Scene):
    def construct(self):
        # Same background color as previous scenes
        self.camera.background_color = "#F0F0F0"
...
class ComplementProperty4(Scene):
    def construct(self):
        # Same background color as previous scenes
        self.camera.background_color = "#F0F0F0"
