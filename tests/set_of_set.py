...
class SetsOfSetsExample(Scene):
    def construct(self):
        ...
        # Check marks using SVG
        check1 = SVGMobject("images/check.svg", height=0.5, color=GREEN)
        check1.next_to(statement1, RIGHT, buff=0.5)
        
        check2 = SVGMobject("images/check.svg", height=0.5, color=GREEN)
        check2.next_to(statement2, RIGHT, buff=0.5)
        
        check3 = SVGMobject("images/check.svg", height=0.5, color=GREEN)
        check3.next_to(statement3, RIGHT, buff=0.5)
        
        check4 = SVGMobject("images/check.svg", height=0.5, color=GREEN)
...
class PowerSetDefinition(Scene):
    def construct(self):
        # Same background color as previous scenes
        self.camera.background_color = "#F0F0F0"
...
class IndexedFamiliesOfSets(Scene):
    def construct(self):
        # Same background color as previous scenes
        self.camera.background_color = "#F0F0F0"
