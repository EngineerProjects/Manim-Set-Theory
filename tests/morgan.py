...
class DeMorganLawsStatement(Scene):
    def construct(self):
        # Same background color as previous scenes
        self.camera.background_color = "#F0F0F0"
        ...
        self.play(
            FadeOut(VGroup(example_line1, example_line2, real_formula, quote_line1, quote_line2, law1_new_position)),
            run_time=1
        )
        self.wait(0.5)
...
class DeMorganDualityPrinciple(Scene):
    def construct(self):
        # Same background color as previous scenes
        self.camera.background_color = "#F0F0F0"
