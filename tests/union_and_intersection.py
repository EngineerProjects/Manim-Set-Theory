...
class UnionIntersectionTitle(Scene):
    def construct(self):
...
class UnionIntersectionIntroduction(Scene):
    def construct(self):
        # Same background color as previous scenes
        self.camera.background_color = "#F0F0F0"
...
class UnionIntersectionExplanation(Scene):
    def construct(self):
        # Same background color as previous scenes
        self.camera.background_color = "#F0F0F0"
...
class IntersectionDefinition(Scene):
    def construct(self):
        # Same background color as previous scenes
        self.camera.background_color = "#F0F0F0"
...
class UnionIntersectionExamples(Scene):
    def construct(self):
        # Same background color as previous scenes
        self.camera.background_color = "#F0F0F0"
...
class UnionIntersectionExamples2(Scene):
    def construct(self):
        # Same background color as previous scenes
        self.camera.background_color = "#F0F0F0"
...
class UnionProperties(Scene):
    def construct(self):
        ...
        self.play(
            FadeOut(VGroup(
                properties, property4, circle_B, circle_A, 
                filled_circle_B, filled_circle_A, label_A, label_B
            )),
            run_time=1.5
        )
        self.wait(1)
...
class IntersectionProperties(Scene):
    def construct(self):
        # Same background color as previous scenes
        self.camera.background_color = "#F0F0F0"
        ...
        self.play(
            FadeOut(VGroup(
                properties, property4, circle_B, circle_A, 
                filled_circle_A, label_A, label_B
            )),
            run_time=1.5
        )
        self.wait(1)
...
class UnionIntersectionCardinality(Scene):
    def construct(self):
        # Same background color as previous scenes
        self.camera.background_color = "#F0F0F0"
...
class MixingUnionsIntersections(Scene):
    def construct(self):
        # Same background color as previous scenes
        self.camera.background_color = "#F0F0F0"
...
class DistributiveLawsComparison(Scene):
    def construct(self):
        # Same background color as previous scenes
        self.camera.background_color = "#F0F0F0"
...
class UnionRealWorldExample(Scene):
    def construct(self):
        # Same background color as previous scenes
        self.camera.background_color = "#F0F0F0"
...
class DistributiveLawProof(Scene):
    def construct(self):
        # Same background color as previous scenes
        self.camera.background_color = "#F0F0F0"
